...
public class ControlerPuestoEmpleado {
    ...
    public ResponseEntity<PuestoEmpleado> registrar(@RequestParam("nombre") String nombre){
        try {
            PuestoEmpleado nuevo = puestoEmpleadoServices.registrar(nombre);
    ...
    public ResponseEntity<PuestoEmpleado> actualizarPuesto(@PathVariable Long id, @RequestParam("nombre") String nombre) {
        try {
            PuestoEmpleado actualizar = puestoEmpleadoServices.actualizar(id, nombre);
